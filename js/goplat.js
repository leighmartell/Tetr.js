...
(function() {
  var DATA_ROOT = "/tetriscideLEIGH1111/";
  ...
  function init() {
    ...
    master.on('set', function(resp) {
      ...
      if (tetriscide.me.id == tetriscide.gameState.master) {
        document.body.style.background = '#21610B';
      } else {
        document.body.style.background = '#610B0B';
      }
    });
